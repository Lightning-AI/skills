...
| [`lightning-blog`](lightning-blog/SKILL.md) | Write, edit, illustrate and publish posts on `lightning.ai/blog`: Markdown import, EditorJS blocks, dark-mode charts from SVG, image uploads, metadata/slug/author/social image, draft review links, publish and unpublish (needs the internal blog-admin flag) |
