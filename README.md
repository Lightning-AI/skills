...
**Tutorial:** [teach a 4B model to call tools on a cloud GPU](examples/finetune-eval/README.md). It starts from a Mac or a Claude cloud session and one chat message.
